	...
	<section class="container">
		...
		<form:form class="form-signin" action="userLogin" method="post">
			...
			<div class="form-group">
				<label class="label label-primary">Username/Email</label> <input type="text" name="login"
					class="form-control" />
			</div>
			<div class="form-group">
				<label class="label label-primary">Password</label> <input type="password" name="password"
					class="form-control" />
			</div>
			<div class="text-center">
			<button type="submit" class="btn btn-primary btn-block d-inline">Login</button>
			<a href="${pageContext.request.contextPath}/registerForm" class="d-inline">Register</a>
			</div>
		</form:form>
	</section>
